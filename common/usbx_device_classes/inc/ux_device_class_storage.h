...
/* Value matches the SCSI INQUIRY Removable Media Bit (RMB, byte 1 bit 7).  */

#define UX_SLAVE_CLASS_STORAGE_MEDIA_IS_NOT_REMOVABLE              0x00
#define UX_SLAVE_CLASS_STORAGE_MEDIA_IS_REMOVABLE                  0x80

/* Define Storage Class medium loaded/ejected state values.  */

#define UX_SLAVE_CLASS_STORAGE_MEDIUM_EJECTED                      0x00
#define UX_SLAVE_CLASS_STORAGE_MEDIUM_LOADED                       0x01
