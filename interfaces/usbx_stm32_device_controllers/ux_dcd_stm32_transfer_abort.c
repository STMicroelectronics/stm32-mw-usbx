...
/*  CALLS                                                                 */
/*                                                                        */
/*    HAL_PCD_AbortEndpointTransfer         Abort Transfer data           */
/*    HAL_PCD_FlushEndpoint                 Flush Endpoint                */
/*                                                                        */
/*  CALLED BY                                                             */
/*                                                                        */
/*    STM32 Controller Driver                                             */
...
UINT _ux_dcd_stm32_transfer_abort(UX_DCD_STM32 *dcd_stm32, UX_SLAVE_TRANSFER *transfer_request)
{
  ...
  HAL_PCD_AbortEndpointTransfer(dcd_stm32 -> pcd_handle, endpoint->ux_slave_endpoint_descriptor.bEndpointAddress);
