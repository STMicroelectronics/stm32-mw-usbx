...
/*  CALLS                                                                 */
/*                                                                        */
/*    HAL_PCD_OpenEndpoint                  Open endpoint                 */
/*                                                                        */
/*  CALLED BY                                                             */
/*                                                                        */
/*    STM32 Controller Driver                                             */
...
UINT _ux_dcd_stm32_endpoint_create(UX_DCD_STM32 *dcd_stm32, UX_SLAVE_ENDPOINT *endpoint)
{
  ...
  if ((ed -> ux_dcd_stm32_ed_status & UX_DCD_STM32_ED_STATUS_USED) == 0)
  {
    ...
    {
      /* Open the endpoint.  */
      HAL_PCD_OpenEndpoint(dcd_stm32 -> pcd_handle, endpoint -> ux_slave_endpoint_descriptor.bEndpointAddress,
                           endpoint -> ux_slave_endpoint_descriptor.wMaxPacketSize,
                           (hal_pcd_ep_type_t)(endpoint -> ux_slave_endpoint_descriptor.bmAttributes & UX_MASK_ENDPOINT_TYPE));
    }
