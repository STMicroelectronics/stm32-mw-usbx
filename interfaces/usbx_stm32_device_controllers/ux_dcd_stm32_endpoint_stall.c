...
/*  CALLS                                                                 */
/*                                                                        */
/*    HAL_PCD_SetEndpointStall              Set STALL condition           */
/*                                                                        */
/*  CALLED BY                                                             */
/*                                                                        */
/*    STM32 Controller Driver                                             */
...
UINT _ux_dcd_stm32_endpoint_stall(UX_DCD_STM32 *dcd_stm32, UX_SLAVE_ENDPOINT *endpoint)
{
  ...
  /* Stall the endpoint.  */
  HAL_PCD_SetEndpointStall(dcd_stm32 -> pcd_handle, endpoint->ux_slave_endpoint_descriptor.bEndpointAddress | ed -> ux_dcd_stm32_ed_direction);
